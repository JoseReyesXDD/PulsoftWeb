      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.header}>
         ...
         />
          ...
          <Text style={styles.email}>{username ? `${username}@ejemplo.com` : 'usuario@ejemplo.com'}</Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Información Personal</Text>
          <Text style={styles.infoText}>Nombre: {username || 'Usuario'}</Text>
          <Text style={styles.infoText}>Email: {username ? `${username}@ejemplo.com` : 'usuario@ejemplo.com'}</Text>
